...
public:
    ...
    void setupUi(QWidget *LoginWindow)
    {
        ...
        head->addWidget(logo, 0, Qt::AlignmentFlag::AlignHCenter|Qt::AlignmentFlag::AlignVCenter);
        ...
        head->addWidget(motto, 0, Qt::AlignmentFlag::AlignHCenter|Qt::AlignmentFlag::AlignVCenter);


        Login->addLayout(head);

        InformationInput = new QVBoxLayout();
        InformationInput->setObjectName("InformationInput");
...
"}"));
        ...
        Captcha_Input_Image->setObjectName("Captcha_Input_Image");
        ...
        captcha_lineEdit->setEchoMode(QLineEdit::EchoMode::Normal);

        Captcha_Input_Image->addWidget(captcha_lineEdit);

        captcha_image = new QPushButton(LoginWindow);
        captcha_image->setObjectName("captcha_image");
...
"}"));
        ...
        Login->addWidget(Forget_password, 0, Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTop);
        ...
        Three_party_login->setObjectName("Three_party_login");
        Three_party_login_horizontalSpacer_left = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
...
"}"));
        ...
        Three_party_login->addWidget(three_party_login, 0, Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignVCenter);
        ...
        Three_party_login->addWidget(wechat, 0, Qt::AlignmentFlag::AlignLeft);
        ...
        Three_party_login->addWidget(github, 0, Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);

        Three_party_login_horizontalSpacer_right = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        NoAuth->setObjectName("NoAuth");
        NoAuth_horizontalSpacer_left = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        NoAuth->addItem(NoAuth_horizontalSpacer_left);

        no_auth = new QLabel(LoginWindow);
        no_auth->setObjectName("no_auth");
...
"}"));
        ...
        NoAuth->addWidget(no_auth, 0, Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignVCenter);
...
"}"));
        ...
        NoAuth->addWidget(label, 0, Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);

        NoAuth_horizontalSpacer_right = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
